 ...
 *     @OA\Property(property="appointment_type", type="string", example="treatment")
 * )
 */
...
class AppointmentRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'treatment_id.required' => 'ID điều trị là bắt buộc.',
            'treatment_id.exists' => 'ID điều trị không tồn tại.',
