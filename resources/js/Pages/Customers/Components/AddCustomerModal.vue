    ...
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        ...
        <div class="px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
          <h3 class="text-lg font-medium leading-6 text-gray-900 dark:text-slate-200 mb-4">Thêm khách hàng mới</h3>
          ...
          <form @submit.prevent="addCustomer">
            <div class="mb-4">
              <label for="full_name" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
                Họ và tên <span class="text-red-500">*</span>
              </label>
              <input type="text" id="full_name" v-model="form.full_name" required
                class="mt-1 block w-full rounded-md border-gray-300 dark:border-slate-600 dark:bg-slate-700 
                dark:text-slate-200 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 
                focus:ring-opacity-50 dark:focus:border-slate-500 dark:focus:ring-slate-500 
                dark:placeholder-slate-400">
            </div>
            <div class="mb-4">
              <label for="phone_number" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
                Số điện thoại
              </label>
            ...
            <div class="mb-4">
              <label for="gender" class="block text-sm font-medium text-gray-700 dark:text-slate-300">
            ...
            <div class="mb-4">
              <label for="date_of_birth" class="block text-sm font-medium text-gray-700 dark:text-slate-300">Ngày sinh</label>
        ...
        <div class="bg-gray-50 dark:bg-slate-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button @click="addCustomer" type="button"
            ...
            focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm dark:focus:ring-offset-slate-800"
