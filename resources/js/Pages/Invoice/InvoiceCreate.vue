    ...
    <LayoutAuthenticated>
        ...
        <SectionMain>
            <div class="container mx-auto px-4 py-8">
                <h1 class="text-3xl font-bold mb-6 dark:text-gray-100">Tạo hóa đơn mới</h1>
                                ...
                                <ul v-if="item.searchResults.length > 0"
                                    ...
                                    <li v-for="result in item.searchResults" :key="result.id"
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <span v-else class="text-sm dark:text-gray-400">
                ...
                <!-- Xem trước hóa đơn -->
                <div class="mt-8">
                    <h2 class="text-2xl font-bold mb-4 dark:text-gray-100">Xem trước hóa đơn</h2>
                    <div v-if="form.user_id" class="bg-white dark:bg-dark-surface shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-6">
                            ...
                            <div class="bg-gray-50 dark:bg-dark-surface/50 rounded-lg p-4">
                                <h4 class="font-medium text-gray-700 dark:text-gray-300 mb-2">Thông tin khách hàng</h4>
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
...
import { useForm, router } from '@inertiajs/vue3'  // Thay đi import
