        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <span v-if="validationErrors.category_id" class="text-red-500 text-sm">{{ validationErrors.category_id }}</span>
                </div>
...
const handleSubmit = async () => {
    ...
    try {
        await form.put(route('products.update', props.product.id), {
            onSuccess: () => {
