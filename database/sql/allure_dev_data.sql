...
INSERT INTO products (category_id, brand_id, product_name, product_line, description, price, volume,
                      stock_quantity)
VALUES (1, 1, 'FAITH Members Club Face Lamela Veil EX Cleansing', 'Faith', 
        'Dành cho mọi loại da, kể cả da nhạy cảm. Giúp loại bỏ lớp trang điểm và bã nhờn dư thừa mà không làm khô da.',
        1000000, '200ml', 100),
       (2, 1, 'FAITH Members Club Face Lamela Veil EX Wash', 'Faith', 
        'Sữa rửa mặt tạo bọt giúp loại bỏ bụi bẩn, bã nhờn và lớp trang điểm còn sót lại, cho làn da sạch thoáng, mềm mại.',
        800000, '80g', 100),
       (3, 1, 'FAITH Members Club Face Lamela Veil EX Moist Keep Essence', 'Faith', 
        'Cung cấp độ ẩm sâu, cho làn da căng mọng và đàn hồi. Giúp cải thiện tình trạng da khô, nếp nhăn, chảy xệ.',
        1200000, '50ml', 100),
       (4, 1, 'FAITH Members Club Face Lamela Veil EX Moist Keep Lotion', 'Faith', 
        ...
        900000, '120ml', 100),
       (5, 1, 'FAITH Members Club Face Lamela Veil EX Moist Keep Gel', 'Faith', 
        ...
        1100000, '30g', 100),
       (6, 1, 'FAITH Members Club Face Insist Lamela Sun Protector Essence N1', 'Faith', 
        'Kem chống nắng dạng tinh chất với các thành phần dịu nhẹ cho da, bảo vệ và dưỡng ẩm cho làn da suốt cả ngày.',
        1300000, '50ml', 100),
       (7, 1, 'FAITH Members Club Face Insist Lamela Gel Foundation N1 G10(G10)', 'Faith', 
