...
VALUES (1, '/images/products/cleansing.jpg'),
       (2, '/images/products/face_wash.jpg'),
       (3, '/images/products/essence.jpg'),
       (4, '/images/products/lotion.jpg'),
       (5, '/images/products/gel.jpg'),
       (6, '/images/products/sunscreen.jpg'),
       (7, '/images/products/foundation.jpg'),
       (8, '/images/users/default.png');
...
INSERT INTO products (name, price, category_id, image_id, quantity)
VALUES ('FAITH Members Club Face Lamela Veil EX Cleansing', 1000000, 1, 1, 100),
...
INSERT INTO product_details (product_id, brand_description, `usage`, benefits, key_ingredients, ingredients, directions,
...
VALUES (1, 'FAITH',
        ...
        'Kết cấu sản phẩm mềm mượt, dễ tán đều, mang đến làn da sạch thoáng, ẩm mịn.', 'Gelatin Collagen*1',
        ...
        'Sử dụng hàng ngày, sáng và tối', 'Bảo quản nơi khô ráo, thoáng mát, tránh ánh nắng trực tiếp',
       ...
       (2, 'FAITH',
        ...
        'Sử dụng hàng ngày, sáng và tối', 'Bảo quản nơi khô ráo, thoáng mát', 'Phù hợp cho mọi loại da'),
       (3, 'FAITH',
       ...
       (6, 'FAITH',
        ...
        'Sử dụng hàng ngày, 15-30 phút trước khi ra nắng', 'Bảo quản nơi khô ráo, thong mát, tránh ánh nng trực tiếp',
        'Phù hợp cho mọi loại da'),
       (7, 'FAITH',
...
SELECT id, '123 Đường ABC, Quận 1, TP.HCM', 'home'
FROM users
WHERE email = 'admin@example.com'
UNION ALL
SELECT id, '456 Đường XYZ, Quận 2, TP.HCM', 'work'
FROM users
WHERE email = 'user@example.com';

-- Chèn dữ liệu vào bảng vouchers
INSERT INTO vouchers (code, description, discount_type, discount_value, start_date, end_date)
VALUES ('WELCOME10', 'Giảm 10% cho khách hàng mới', 'percentage', 10, '2023-01-01', '2023-12-31'),
