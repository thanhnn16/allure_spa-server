...
INSERT INTO invoices (id, user_id, staff_user_id, total_amount, paid_amount, status, payment_method, note, created_by_user_id, created_at)
SELECT 
    UUID(),                           -- id
    u.id,                             -- user_id
    s.id,                             -- staff_user_id
